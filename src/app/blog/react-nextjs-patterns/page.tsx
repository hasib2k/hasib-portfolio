        ...
        <div key={item.id} onClick={() => handleUpdate(item.id)}>
          {item.name}
                ...
                <section>
                  ...
                  <h3 className="text-2xl font-semibold mb-4" style={{color: '#104F8F'}}>Zustand for Simple State Management</h3>
                  <div className="bg-white/20 rounded-lg p-6 mb-6 border" style={{borderColor: '#B7C9E2'}}>
                    <pre className="text-sm overflow-x-auto" style={{color: '#104F8F'}}>
  ...
  return (
    <div>
      {user ? <p>Welcome, {user.name}</p> : <p>Please log in</p>}
                  ...
                  <h3 className="text-2xl font-semibold mb-4" style={{color: '#104F8F'}}>React Query for Server State</h3>
                  <div className="bg-white/20 rounded-lg p-6 mb-6 border" style={{borderColor: '#B7C9E2'}}>
                    <pre className="text-sm overflow-x-auto" style={{color: '#104F8F'}}>
