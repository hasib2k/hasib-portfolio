...
export default function QuickChatButton() {
  ...
  return (
    <>
      <button
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 sm:px-5 py-3 rounded-full text-white shadow-lg transition-all duration-300 focus:outline-none focus:ring-2"
        style={{fontWeight: '600', backgroundColor: '#104F8F', boxShadow: '0 4px 24px 0 #B7C9E2'}}
      ...
      {showPopup && (
        <div className="fixed inset-0 z-50 flex items-end justify-end">
          ...
          <div className="relative m-6 w-full max-w-xs bg-white rounded-xl shadow-xl p-6 flex flex-col items-center animate-fadeIn" style={{boxShadow: '0 4px 24px 0 #B7C9E2'}}>
